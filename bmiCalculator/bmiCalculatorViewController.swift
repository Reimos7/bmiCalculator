...
class bmiCalculatorViewController: UIViewController {
    ...
    @IBAction func resultButtonClicked(_ sender: UIButton) {
        ...
        // 1) alert창 제목, 메세지 설정
        let alert = UIAlertController(title: "BMI 결과", message: "\(bmiCalculate())", preferredStyle: .alert)
    ...
    @IBAction func randomButtonClicked(_ sender: UIButton)  {
        // 1) alert창 제목, 메세지 설정
        let alert = UIAlertController(title: "BMI 결과", message: "\(randomBmiCalculator())", preferredStyle: .alert)
